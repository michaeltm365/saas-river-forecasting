...
| Site (dry frac) | Logistic Regression | XGBoost | LSTM (HOBO only) | RGCN (strict, with-sensor holdout) |
|---|--:|--:|--:|--:|
| 097170 (0.40) | 0.411 / 1.00 | 0.938 / 0.87 | 0.525 / 1.00 | 0.954 / 0.92 |
| 100137 (0.68) | 0.779 / 0.71 | 0.947 / 0.94 | 0.229 / 0.20 | 0.816 / 0.79 |
| 099610 (0.00) | 1.000 | 1.000 | 1.000 | 1.000 |
| 235848 (0.00) | 1.000 | 1.000 | 1.000 | 0.976 |
| 271029 (0.00) | 1.000 | 1.000 | 1.000 | 0.976 |
